  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-secondary text-white hover:bg-gradient-accent transform hover:scale-105 hover:shadow-glow transition-all duration-300",
        primary: "bg-gradient-primary text-white hover:opacity-90 shadow-medium hover:shadow-large transition-all duration-300",
        cta: "bg-secondary text-white hover:bg-secondary-dark transform hover:scale-105 shadow-medium hover:shadow-large transition-all duration-300",
      },
      size: {
